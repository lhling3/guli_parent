...
public class TestVod1 {
    ...
    public void testGetVideoPlayAuth() throws ClientException {
        ...
        try {
            ...
            //设置请求参数
            request.setVideoId("58f1b0135b9340638d24930d62eb5527");
            //获取请求响应
    ...
    public void testUploadVideo(){
        ...
        //文件名必须包含扩展名
        String fileName = "E:\\编程学习资料\\练手项目资料\\谷粒学院\\资料\\1-阿里云上传测试视频\\6 - What If I Want to Move Faster.mp4";
        //本地文件上传
        UploadVideoRequest request = new UploadVideoRequest("LTAI5t7BoHzybdXQ92QLwZWE", "CkE9lqmtIl7EwgkTgD1iWA9kmUVXkg", title, fileName);
