...
public class AudioOrVideoCreateUploadDemo {
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient client) throws Exception {
        ...
        request.setStorageLocation("outin-bcbc1685bfbd11ecbfcd00163e021072.oss-cn-shenzhen.aliyuncs.com");
    ...
    public static void main(String[] argv) throws ClientException {
        try {
            DefaultAcsClient client = initVodClient("LTAI5t7BoHzybdXQ92QLwZWE", "CkE9lqmtIl7EwgkTgD1iWA9kmUVXkg");
